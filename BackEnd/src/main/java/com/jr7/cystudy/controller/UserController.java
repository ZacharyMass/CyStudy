...
public class UserController {
     ...
     *
     * @param username String of username of a User object to check the role of (sent as url parameter)
     ...
     *
     * @param username String url parameter of the username portion of a User object you're checking that exists
     ...
     * @return String saying that either the user exists, or that a user with that username already exists
     * @throws Exception if username is already taken, don't add this user and throw this exception instead
     */
     ...
     * @return String saying that the user doesn't exist, the password was correct, or the password was incorrect
     * @see UserService
     */
