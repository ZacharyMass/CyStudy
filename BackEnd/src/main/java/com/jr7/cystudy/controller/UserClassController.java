...
/**
 * UserClassController is exactly what it's name says. This connects to the userclass table in the database to store
 * all of the classes the a user is connected to. This uses both the User and Classes models.
 *
...
public class UserClassController {
    ...
    /**
     * Endpoint to register a user for a specific class. This first checks to ensure that a user and class exist,
     * and then checks to see if the user is already registered in the class. If the user and class exist, and the user
     * is not already registered for the specified class, then the user is registered for the class.
     *
     * @param  uC      JSON cast to a userclass object containing at least a username and classname.
     * @return string  either "User is not registered," "Class does not exist," "User already in class," or
     *                 "user added to class."
     */
