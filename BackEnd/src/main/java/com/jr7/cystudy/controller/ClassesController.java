...
public class ClassesController {
    ...
    /**
     * Endpoint to check if a class exists. Not sure when this would be used, but figured it might be useful at some
     * point on some admin page to check if a className exists before it's added in
     *
